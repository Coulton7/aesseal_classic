...
<div>
  <div class ="popup-content info">
    ...
    <div id="popup-buttons">
      <button type="button" class="agree-button"><?php print t('OK, I agree'); ?></button>
      <button type="button" class="find-more-button"><?php print $disagree_button; ?><?php print t('Privacy Policy'); ?></button>
    </div>
  </div>
</div>
